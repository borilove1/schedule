    ...
    <div>
      ...
      <div style={{
        ...
        <form onSubmit={handleSearch} style={{ display: 'flex', gap: '8px', flex: 1, minWidth: '200px' }}>
          <div style={{ position: 'relative', flex: 1 }}>
            <Search size={16} style={{ position: 'absolute', left: '10px', top: '50%', transform: 'translateY(-50%)', color: secondaryText }} />
            <input
              type="text"
              value={search}
      ...
      {error && (
        <div style={{
          padding: '12px',
          marginBottom: '16px',
          backgroundColor: isDarkMode ? '#3b1c1c' : '#fef2f2',
          color: '#ef4444',
          borderRadius: '6px',
          fontSize: '13px',
        }}>{error}</div>
        ...
        <div style={{ overflowX: 'auto' }}>
          <table style={{ width: '100%', minWidth: '900px', borderCollapse: 'separate', borderSpacing: 0, fontSize: '13px' }}>
            ...
            <tbody>
              {loading ? (
                <tr>
                  <td colSpan={8} style={{ padding: '40px', textAlign: 'center', color: secondaryText }}>
                    로딩 중...
                  </td>
                </tr>
              ) : users.length === 0 ? (
                ...
                return (
                  <tr key={user.id} style={{ borderBottom: `1px solid ${borderColor}` }}>
                    ...
                    <td style={{ padding: '12px 16px', color: secondaryText }}>{user.email}</td>
                    <td style={{ padding: '12px 16px' }}>{user.position}</td>
                    <td style={{ padding: '12px 16px', color: secondaryText, whiteSpace: 'nowrap' }}>
                    ...
                    <td style={{ padding: '12px 16px' }}>
                      <span style={{
                        ...
                        color: user.role === 'ADMIN' ? '#a78bfa' : user.role === 'DEPT_LEAD' ? '#60a5fa' : secondaryText,
                      }}>
                    ...
                    <td style={{ padding: '12px 16px', color: secondaryText, whiteSpace: 'nowrap', fontSize: '12px' }}>
                      {user.last_login_at
          ...
          <div style={{
            ...
            <button
              ...
              style={{
                ...
                color: pagination.page >= pagination.totalPages ? borderColor : textColor,
      ...
      {deleteConfirm && (
        <div style={{
          ...
          <div style={{
            ...
            <h3 style={{ margin: '0 0 12px', fontSize: '16px', color: textColor }}>사용자 삭제</h3>
